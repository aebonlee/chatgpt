        ...
        <div className="footer-content">
          ...
          <div className="footer-links">
            ...
            <ul className="footer-link-list">
              <li><Link to="/chatgpt-basics">{language === 'ko' ? 'ChatGPT 기초' : 'ChatGPT Basics'}</Link></li>
              <li><Link to="/prompt-engineering">{language === 'ko' ? '프롬프트 엔지니어링' : 'Prompt Engineering'}</Link></li>
              <li><Link to="/gpts-store">GPTs & GPT Store</Link></li>
              <li><Link to="/api-usage">API {language === 'ko' ? '활용' : 'Usage'}</Link></li>
              <li><Link to="/advanced-features">{language === 'ko' ? '고급 기능' : 'Advanced Features'}</Link></li>
              <li><Link to="/model-comparison">{language === 'ko' ? '모델 비교' : 'Model Comparison'}</Link></li>
            </ul>
          </div>
