import{u as h,j as e}from"./index-BNnHycnZ.js";import{b as p}from"./vendor-ByVyFa1h.js";import{S as m}from"./SEOHead-CcflFH0m.js";import{C as n}from"./CodeBlock-sL-MrAzE.js";import{T as o}from"./TipBox-Dl4N7OG2.js";const s=[{id:"setup",icon:"fa-key",ko:"API 시작하기",en:"Getting Started"},{id:"chat",icon:"fa-message",ko:"Chat Completions",en:"Chat Completions"},{id:"streaming",icon:"fa-stream",ko:"Streaming",en:"Streaming"},{id:"functions",icon:"fa-wrench",ko:"Function Calling",en:"Function Calling"},{id:"vision",icon:"fa-image",ko:"Vision (이미지)",en:"Vision (Images)"},{id:"assistants",icon:"fa-robot",ko:"Assistants API",en:"Assistants API"},{id:"pricing",icon:"fa-credit-card",ko:"요금제 & 최적화",en:"Pricing & Optimization"}];function A(){const{language:l}=h(),t=l==="ko",[r,d]=p.useState("setup"),i=s.findIndex(a=>a.id===r),c=a=>{d(a),window.scrollTo({top:0,behavior:"smooth"})};return e.jsxs(e.Fragment,{children:[e.jsx(m,{title:t?"OpenAI API 사용법":"OpenAI API Usage",description:t?"OpenAI API를 활용한 개발 가이드. Chat Completions, Streaming, Function Calling, Vision, Assistants API까지 체계적으로 학습합니다.":"A comprehensive guide to OpenAI API development. Learn Chat Completions, Streaming, Function Calling, Vision, and Assistants API.",path:"/api-usage"}),e.jsxs("div",{className:"guide-page",children:[e.jsx("aside",{className:"guide-sidebar",children:e.jsxs("nav",{className:"guide-nav",children:[e.jsxs("h3",{className:"guide-nav-title",children:[e.jsx("i",{className:"fa-solid fa-code"}),t?"API 가이드":"API Guide"]}),e.jsx("ul",{className:"guide-nav-list",children:s.map(a=>e.jsx("li",{children:e.jsxs("button",{className:`guide-nav-item ${r===a.id?"active":""}`,onClick:()=>c(a.id),children:[e.jsx("i",{className:`fa-solid ${a.icon}`}),t?a.ko:a.en]})},a.id))})]})}),e.jsxs("main",{className:"guide-content",children:[e.jsxs("div",{className:"guide-header",children:[e.jsxs("h1",{children:[e.jsx("i",{className:`fa-solid ${s[i].icon}`}),t?s[i].ko:s[i].en]}),e.jsxs("p",{className:"guide-step-indicator",children:[i+1," / ",s.length]})]}),r==="setup"&&e.jsxs("section",{className:"guide-section",children:[e.jsx("h2",{children:t?"1. API 키 발급받기":"1. Getting Your API Key"}),e.jsx("p",{children:t?"OpenAI API를 사용하려면 먼저 API 키가 필요합니다. platform.openai.com에서 계정을 만들고 API 키를 발급받으세요.":"To use the OpenAI API, you first need an API key. Create an account at platform.openai.com and generate your API key."}),e.jsxs("ol",{children:[e.jsx("li",{children:t?"platform.openai.com 에 접속하여 회원가입":"Sign up at platform.openai.com"}),e.jsx("li",{children:t?"Settings > API keys 메뉴로 이동":"Navigate to Settings > API keys"}),e.jsx("li",{children:t?'"Create new secret key" 클릭':'Click "Create new secret key"'}),e.jsx("li",{children:t?"생성된 키를 안전한 곳에 저장 (한 번만 표시됨!)":"Save the generated key securely (shown only once!)"})]}),e.jsx(o,{type:"warning",children:t?"API 키는 절대로 코드에 직접 하드코딩하지 마세요! 환경 변수나 시크릿 매니저를 사용하세요.":"Never hardcode API keys directly in your code! Use environment variables or a secret manager."}),e.jsx("h2",{children:t?"2. SDK 설치하기":"2. Installing the SDK"}),e.jsx("h3",{children:"Python"}),e.jsx(n,{language:"bash",code:"pip install openai"}),e.jsx("h3",{children:"Node.js"}),e.jsx(n,{language:"bash",code:"npm install openai"}),e.jsx("h2",{children:t?"3. 환경 변수 설정":"3. Setting Environment Variables"}),e.jsx("p",{children:t?"API 키를 환경 변수로 설정하면 코드에서 안전하게 사용할 수 있습니다.":"Setting the API key as an environment variable keeps your code secure."}),e.jsx(n,{language:"bash",code:`# .env 파일 생성
...
$env:OPENAI_API_KEY="sk-your-api-key-here"`}),e.jsx("h2",{children:t?"4. 첫 번째 API 호출":"4. Your First API Call"}),e.jsx("h3",{children:"Python"}),e.jsx(n,{language:"python",code:`from openai import OpenAI
...
print(response.choices[0].message.content)`}),e.jsx("h3",{children:"Node.js"}),e.jsx(n,{language:"javascript",code:`import OpenAI from 'openai';
...
print()  # 줄바꿈
print(f"\\n전체 응답: {collected_content}")`}),e.jsx("h2",{children:t?"Node.js 스트리밍 구현":"Node.js Streaming Implementation"}),e.jsx(n,{language:"javascript",code:`import OpenAI from 'openai';
...
print(response.choices[0].message.content)`}),e.jsx("h2",{children:t?"Base64 인코딩 방식":"Base64 Encoding Method"}),e.jsx(n,{language:"python",code:`import base64
from openai import OpenAI
...
with client.beta.threads.runs.stream(
    ...
    stream.until_done()`}),e.jsx(o,{type:"important",children:t?"Assistants API는 베타 버전이므로 client.beta 네임스페이스를 사용합니다. API가 안정화되면 변경될 수 있으니 공식 문서를 주기적으로 확인하세요.":"The Assistants API is in beta, so it uses the client.beta namespace. As the API stabilizes, it may change, so check the official documentation regularly."})]}),r==="pricing"&&e.jsxs("section",{className:"guide-section",children:[e.jsx("h2",{children:t?"모델별 가격 비교":"Model Pricing Comparison"}),e.jsx("p",{children:t?"OpenAI API는 사용한 토큰 수에 따라 과금됩니다. 모델마다 가격이 다르며, 입력(Input)과 출력(Output) 토큰의 단가도 다릅니다.":"OpenAI API charges based on token usage. Pricing varies by model, and input and output tokens have different unit prices."}),e.jsx("div",{className:"guide-table-wrapper",children:e.jsxs("table",{className:"guide-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:t?"모델":"Model"}),e.jsx("th",{children:t?"입력 (1M 토큰)":"Input (1M tokens)"}),e.jsx("th",{children:t?"출력 (1M 토큰)":"Output (1M tokens)"}),e.jsx("th",{children:t?"특징":"Features"})]})}),e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("strong",{children:"GPT-4o"})}),e.jsx("td",{children:"$2.50"}),e.jsx("td",{children:"$10.00"}),e.jsx("td",{children:t?"최고 성능, 멀티모달":"Best performance, multimodal"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("strong",{children:"GPT-4o-mini"})}),e.jsx("td",{children:"$0.15"}),e.jsx("td",{children:"$0.60"}),e.jsx("td",{children:t?"가성비 최고, 빠른 응답":"Best value, fast response"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("strong",{children:"o1"})}),e.jsx("td",{children:"$15.00"}),e.jsx("td",{children:"$60.00"}),e.jsx("td",{children:t?"추론 특화, 복잡한 문제":"Reasoning focused, complex problems"})]}),e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx("strong",{children:"o3-mini"})}),e.jsx("td",{children:"$1.10"}),e.jsx("td",{children:"$4.40"}),e.jsx("td",{children:t?"경량 추론 모델":"Lightweight reasoning model"})]})]})]})}),e.jsx(o,{type:"important",children:t?"가격은 수시로 변경될 수 있습니다. 최신 가격은 openai.com/pricing에서 확인하세요.":"Pricing may change at any time. Check openai.com/pricing for the latest rates."}),e.jsx("h2",{children:t?"토큰 계산법":"Token Counting"}),e.jsx("p",{children:t?"토큰은 텍스트의 조각입니다. 영어는 약 1단어 = 1.3토큰, 한국어는 약 1글자 = 2~3토큰으로 계산됩니다. tiktoken 라이브러리로 정확한 토큰 수를 계산할 수 있습니다.":"Tokens are pieces of text. English averages about 1 word = 1.3 tokens, while Korean averages about 1 character = 2-3 tokens. Use the tiktoken library for precise token counting."}),e.jsx(n,{language:"python",code:`import tiktoken
